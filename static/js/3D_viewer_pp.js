<script>
    ...
    var viewer_17375858348362794 = null;
    var warn = document.getElementById("3dmolwarning_17375858348362794");
    if (warn) {
    ...
    loadScriptAsync('https://cdnjs.cloudflare.com/ajax/libs/3Dmol/2.4.2/3Dmol-min.js')
        .then(function() {
            ...
            viewer_17375858348362794 = $3Dmol.createViewer(document.getElementById("3dmolviewer_17375858348362794"), { backgroundColor: "white" });
            viewer_17375858348362794.zoomTo();
            viewer_17375858348362794.addModel("HETATM    1  C1  UNL     1       0.000   0.000   0.000  1.00  0.00           C  \\nHETATM    2  H1  UNL     1      -0.586  -0.190   0.923  1.00  0.00           H  \\nHETATM    3  H2  UNL     1       0.460   1.008   0.056  1.00  0.00           H  \\nHETATM    4  H3  UNL     1      -0.672  -0.052  -0.881  1.00  0.00           H  \\nHETATM    5  H4  UNL     1       0.797  -0.766  -0.097  1.00  0.00           H  \\nCONECT    1    2    3    4    5\\nEND", "pdb");
            viewer_17375858348362794.setStyle({ "stick": {} });
            viewer_17375858348362794.zoomTo();
            viewer_17375858348362794.render();
        })
